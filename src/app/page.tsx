...
import { Clock, CheckCircle, Smile } from "lucide-react";
      ...
      <ReactLenis root>
        ...
        <div id="services" data-section="services">
          <FeatureCardMedia
            ...
            features={[
              { id: "1", title: "Kitchen Remodeling", description: "Custom cabinetry and layout design to maximize efficiency and style.", tag: "Popular", imageSrc: "http://img.b2bpic.net/free-photo/front-view-woman-working-with-roller_52683-100074.jpg" },
              { id: "2", title: "Flooring Solutions", description: "Hardwood, tile, and stone installations tailored to your lifestyle.", tag: "Quality", imageSrc: "http://img.b2bpic.net/free-photo/top-view-man-tiling-floor_23-2149344001.jpg" },
              { id: "3", title: "Granite & Countertops", description: "Precision granite installation for kitchens and bathrooms.", tag: "Durable", imageSrc: "http://img.b2bpic.net/free-photo/interior-modern-kitchen-with-wooden-details_169016-20193.jpg" },
            ]}
        ...
        <div id="testimonials" data-section="testimonials">
          <TestimonialCardTwo
            ...
            useInvertedBackground={true}
            testimonials={[
              { id: "1", name: "Sarah Miller", role: "Homeowner", testimonial: "Excellent service and craftsmanship on our kitchen cabinets!", imageSrc: "http://img.b2bpic.net/free-photo/male-plumber-working-with-client-fix-kitchen-problems_23-2150990688.jpg" },
              { id: "2", name: "David Smith", role: "Homeowner", testimonial: "Beautiful floors installed quickly and professionally.", imageSrc: "http://img.b2bpic.net/free-photo/couple-handling-carpet-together-their-new-home_23-2149086839.jpg" },
              { id: "3", name: "Emily Chen", role: "Homeowner", testimonial: "The granite countertops look amazing in our updated kitchen.", imageSrc: "http://img.b2bpic.net/free-photo/interior-designer-clients-discussing-drawings_74855-2943.jpg" },
              { id: "4", name: "Robert J.", role: "Homeowner", testimonial: "Very communicative and transparent team. Highly recommended.", imageSrc: "http://img.b2bpic.net/free-photo/portrait-happy-family-kitchen-decorated-christmas_93675-131215.jpg" },
              { id: "5", name: "Lisa B.", role: "Homeowner", testimonial: "Bathroom remodel turned out better than we imagined!", imageSrc: "http://img.b2bpic.net/free-photo/full-shot-woman-holding-roller_23-2148903440.jpg" },
            ]}
        ...
        <div id="contact" data-section="contact">
          <ContactText
            ...
            buttons={[
              ...
              { text: "Send Email", href: "mailto:info@dsflooring.com" },
            ]}
          />
        </div>
        ...
        <div id="footer" data-section="footer">
          <FooterLogoEmphasis
            columns={[
              { items: [{ label: "Kitchen Remodeling", href: "#services" }, { label: "Bathroom Remodeling", href: "#services" }, { label: "Custom Cabinets", href: "#services" }, { label: "Flooring Solutions", href: "#services" }] },
              { items: [{ label: "Portfolio", href: "#gallery" }, { label: "About Us", href: "#about" }, { label: "Testimonials", href: "#testimonials" }] },
